...
function ensureHESIEProgram() {
  ...
  const steps = [
    ...
    { phase: 'HVAC Replacement', step: 14, title: 'Mechanical Decision Tree Evaluation', desc: 'Follow Mechanical Replacement Decision Trees (Appendix H) to determine if furnace, boiler, water heater, or CAC qualifies for replacement vs. repair/tune-up.', cert: null, forms: 'Mechanical Decision Trees (Appendix H)', timeline: null },
    { phase: 'HVAC Replacement', step: 15, title: 'Submit Tech Report for Replacement', desc: 'When replacement is needed: create tech report documenting equipment condition, decision tree results, and recommended replacement. Email tech report to RI program contacts for approval.', cert: null, forms: 'Tech Report (emailed to RI contacts)', timeline: null },
    { phase: 'HVAC Replacement', step: 16, title: 'Receive Replacement Approval', desc: 'RI reviews tech report and approves or denies replacement request. Track approval status.', cert: null, forms: 'Replacement Approval from RI', timeline: null },
    { phase: 'HVAC Replacement', step: 17, title: 'Manual J & Equipment Selection', desc: 'Complete Manual J load calculation to determine proper equipment sizing. Document what equipment will be installed (make, model, efficiency, size). Required for proper billing.', cert: null, forms: 'Manual J Calculation, Equipment Spec Sheet', timeline: 'Before installation' },
    { phase: 'Installation', step: 18, title: 'Schedule & Perform Work', desc: 'Call customer and schedule installation. Install all approved measures per program specs and BPI standards.', cert: 'Varies by measure type', forms: null, timeline: 'After approval received' },
    { phase: 'Installation', step: 19, title: 'Final Inspection', desc: 'Inspect all work to ensure safe conditions and proper installation. Staff must be BPI BA-P certified.', cert: 'BPI Building Analyst Professional (BA-P)', forms: 'Final Inspection Form (Appendix F)', timeline: null },
    { phase: 'Installation', step: 20, title: 'Customer Sign-Off', desc: 'Customer acknowledges work complete by signing Final Inspection Form.', cert: null, forms: 'Final Inspection Form (Appendix F)', timeline: null },
    { phase: 'Closeout', step: 21, title: 'Post Photos & Documentation', desc: 'Upload all post-installation photos. Ensure all documentation complete per Photo Checklist.', cert: null, forms: 'Documentation and Photo Checklist (Appendix J)', timeline: null },
    { phase: 'Closeout', step: 22, title: 'Customer Education & Survey', desc: 'Educate customer on installed measures. Provide satisfaction survey for customer to mail in.', cert: null, forms: 'Customer Satisfaction Survey (Appendix K)', timeline: null },
    { phase: 'Closeout', step: 23, title: 'Submit for Invoicing', desc: 'Enter all final data into RISE. Ensure HVAC billing matches Manual J and approved equipment. Submit for final approval.', cert: null, forms: 'All closeout documents, RISE submission', timeline: 'Per program calendar' },
    { phase: 'QA/QC', step: 24, title: 'QA/QC Inspection', desc: 'CMC conducts QA/QC inspections on 5% of projects. New contractors: first 5 inspected (80% pass required). Probation: next 10 inspected (80% pass required).', cert: null, forms: 'QAQC Observation Form (Appendix G)', timeline: 'Ongoing' }
  ];
