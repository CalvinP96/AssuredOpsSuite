...
function ensureHESIEProgram() {
  ...
  const steps = [
    ...
    { phase: 'Scope & Pre-Approval', step: 13, title: 'Identify Permit Requirements', desc: 'During scope creation, identify if the job requires any building permits based on work type and local jurisdiction. Flag the job and begin permit tracking.', cert: null, forms: null, timeline: 'During scope creation' },
    { phase: 'Scope & Pre-Approval', step: 14, title: 'Submit for Pre-Approval', desc: 'Submit complete package to RI for pre-approval: signed forms, photos, estimate, all RISE data.', cert: null, forms: 'All pre-approval documents', timeline: 'RI target turnaround: 2 business days' },
    { phase: 'HVAC', step: 15, title: 'Perform Tune & Clean', desc: 'HVAC only gets involved if a tune and clean is recommended during assessment/scoping. Tech performs tune and clean per IL TRM 2026 requirements and produces a tech report. The tech report documents all findings and complies with IL TRM 2026 for tune and cleans in Illinois.', cert: null, forms: 'Tech Report (IL TRM 2026 compliant)', timeline: 'After pre-approval' },
    { phase: 'HVAC', step: 16, title: 'Evaluate Findings & Decision Tree', desc: 'Review tech report findings. If issues are present, apply the Mechanical Replacement Decision Tree (Appendix H) to determine if equipment qualifies for replacement. If no issues are found, the tune and clean is complete and billable - no further HVAC steps needed.', cert: null, forms: 'Mechanical Decision Trees (Appendix H) - only if issues found', timeline: null },
    { phase: 'HVAC', step: 17, title: 'Submit Tech Report for Replacement (If Needed)', desc: 'Only if the decision tree indicates replacement: email tech report with decision tree results and replacement recommendation to RI program contacts for approval.', cert: null, forms: 'Tech Report with replacement recommendation (emailed to RI contacts)', timeline: null },
    { phase: 'HVAC', step: 18, title: 'Receive Replacement Approval', desc: 'RI reviews tech report and approves or denies replacement request. Track approval status.', cert: null, forms: 'Replacement Approval from RI', timeline: null },
    { phase: 'HVAC', step: 19, title: 'Manual J & Equipment Selection', desc: 'Only if replacement approved. Complete Manual J load calculation to determine proper equipment sizing. Document what equipment will be installed (make, model, efficiency, size). Required for proper billing.', cert: null, forms: 'Manual J Calculation, Equipment Spec Sheet', timeline: 'Before installation' },
    { phase: 'Installation', step: 20, title: 'Schedule & Perform Work', desc: 'Call customer and schedule installation. Install all approved measures per program specs and BPI standards.', cert: 'Varies by measure type', forms: null, timeline: 'After approval received' },
    { phase: 'Installation', step: 21, title: 'Final Inspection', desc: 'Inspect all work to ensure safe conditions and proper installation. Staff must be BPI BA-P certified.', cert: 'BPI Building Analyst Professional (BA-P)', forms: 'Final Inspection Form (Appendix F)', timeline: null },
    { phase: 'Installation', step: 22, title: 'Customer Sign-Off', desc: 'Customer acknowledges work complete by signing Final Inspection Form.', cert: null, forms: 'Final Inspection Form (Appendix F)', timeline: null },
    { phase: 'Closeout', step: 23, title: 'Post Photos & Documentation', desc: 'Upload all post-installation photos. Ensure all documentation complete per Photo Checklist.', cert: null, forms: 'Documentation and Photo Checklist (Appendix J)', timeline: null },
    { phase: 'Closeout', step: 24, title: 'Customer Education & Survey', desc: 'Educate customer on installed measures. Provide satisfaction survey for customer to mail in.', cert: null, forms: 'Customer Satisfaction Survey (Appendix K)', timeline: null },
    { phase: 'Closeout', step: 25, title: 'Submit for Invoicing', desc: 'Enter all final data into RISE. Ensure HVAC billing matches Manual J and approved equipment. Submit for final approval.', cert: null, forms: 'All closeout documents, RISE submission', timeline: 'Per program calendar' },
    { phase: 'QA/QC', step: 26, title: 'QA/QC Inspection', desc: 'CMC conducts QA/QC inspections on 5% of projects. New contractors: first 5 inspected (80% pass required). Probation: next 10 inspected (80% pass required).', cert: null, forms: 'QAQC Observation Form (Appendix G)', timeline: 'Ongoing' }
  ];
