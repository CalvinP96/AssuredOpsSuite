...
-- Uses UUID primary keys (Supabase default)
...
CREATE TABLE IF NOT EXISTS measure_photo_requirements (
  id uuid default gen_random_uuid() primary key,
  measure_id uuid not null references program_measures(id),
...
CREATE TABLE IF NOT EXISTS job_measures (
  id uuid default gen_random_uuid() primary key,
  job_id uuid not null references program_jobs(id),
  measure_id uuid not null references program_measures(id),
...
CREATE TABLE IF NOT EXISTS job_checklist_items (
  ...
  description text not null,
  measure_id uuid references program_measures(id),
